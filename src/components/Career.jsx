  ...
  return (
    <Container fluid className="Home-page">
      <Row>
        <Col sm={5}>
          <img
            style={{ height: "600px", marginLeft: "-10px", marginTop: "-80px" }}
        ...
        <Col sm={5} className="hero-second">
          <img
            style={{ height: "600px", marginRight: "10px", marginTop: "-80px" }}
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5 in-section">
              ...
              <div className="col">
                ...
                >
                  ...
                  <p>
                    ...
                    problems excites you, we’re looking for minds like yours to
                    craft innovative solutions that make a difference for our
                    clients.
                  </p>
                </div>
              </div>
              ...
              <div className="col">
                ...
                >
                  ...
                  <p>
                    Join a culture of collaboration where ideas flow freely, and
                    every team member is valued. Together, we’ll create, learn,
                    and evolve—supporting one another to achieve greatness.
                  </p>
                </div>
              </div>
              ...
              <div className="col">
                ...
                >
                  <h5 className="fw-bold mt-3">Empathy-Driven Professionals</h5>
                  <p>
                    Our culture is built on integrity, kindness, and respect. We
                    value inclusivity and equal opportunities, fostering an
              ...
              <div className="col">
                ...
                >
                  ...
                  <p>
                    ...
                    here. Work with like-minded innovators, explore cutting-edge
                    tools, and develop transformative solutions that push the
              ...
              <div className="col">
                ...
                >
                  ...
                  <p>
                    Are you driven to make a difference? Be part of our mission
                    to leverage technology as a force for good—building
                    solutions that are meaningful, inclusive, and accessible to
                    all Are you driven to make a difference.
                  </p>
                </div>
              </div>
              ...
              <div className="col">
                ...
                >
                  ...
                  <p>
                    ...
                    constantly refine your skills in a supportive and enriching
                    environment.
                  </p>
                </div>
              </div>
              ...
              <Card className="shadow-sm">
                <Card.Body>
                  ...
                  <div className="d-flex gap-3 align-items-center mb-2  font-ss">
                    <img style={{ width: 20 }} src="images/Frame.png" alt="" />{" "}
